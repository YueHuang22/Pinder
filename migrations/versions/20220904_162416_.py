...
Revision ID: 758b694b50be
Revises: 
Create Date: 2022-09-04 16:24:16.196481
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['receiver_pet_id'], ['dogs.id'], ),
    sa.ForeignKeyConstraint(['sender_pet_id'], ['dogs.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
